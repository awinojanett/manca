...
function Navbar() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50">
      {/* Top Bar */}
      <div
        className={`bg-white py-2 hidden md:block transition-all duration-300 ${
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-6">
              <div className="flex items-center text-gray-600">
                ...
                <span className="text-sm">+254 722 870222</span>
              </div>
              <div className="flex items-center text-gray-600">
                <Mail className="h-4 w-4 mr-2" />
                <span className="text-sm">contact@manca.com</span>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              <a
                href="#"
                className="text-gray-600 hover:text-manca-blue transition-colors"
              >
                <svg
                  className="h-4 w-4"
                  fill="currentColor"
          ...
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center md:hidden">
              <button
                ...
                className="inline-flex items-center justify-center p-2 rounded-md text-gray-600 hover:text-manca-blue focus:outline-none"
              >
                {isOpen ? (
                  <X className="h-6 w-6" />
                ) : (
