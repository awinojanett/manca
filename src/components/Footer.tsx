        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/programmes" className="hover:text-blue-400 transition-colors">Programs</a></li>
              <li><a href="/community" className="hover:text-blue-400 transition-colors">Get Involved</a></li>
              <li><a href="/donate" className="hover:text-blue-400 transition-colors">Donate</a></li>
            </ul>
          </div>
